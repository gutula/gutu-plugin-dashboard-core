export { DashboardViewResource } from "./resources/main.resource";
export { publishDashboardViewAction } from "./actions/default.action";
export { dashboardPolicy } from "./policies/default.policy";
